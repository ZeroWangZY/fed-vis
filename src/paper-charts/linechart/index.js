...
class PaperLineChart extends React.Component {
  ...
  getPredTrainingRound = () => {
    let training_time = [
      ...
      [41.71342, 29.14247, 22.15034, 15.07501, 8.725, 3.32435].reverse(),
      [41.8106, 28.48756, 21.83103, 15.10012, 8.75004, 3.314].reverse(),
    ];
    ...
    let aggregation_time = [
      ...
      [0.29903, 0.29003, 0.29103, 0.29103, 0.356, 0.302].reverse(),
      [0.291, 0.29803, 0.291, 0.29503, 0.29103, 0.29097].reverse(),
    ];

    let jsd = [
      [0.03214, 0.03021, 0.03077, 0.03363, 0.06412, 0.44739].reverse(),
      [0.00435, 0.00633, 0.00903, 0.01404, 0.02411, 0.09637].reverse(),
      [0.00027, 0.00041, 0.00057, 0.00086, 0.00132, 0.02947].reverse(),
      [0.00017, 0.00018, 0.00019, 0.00021, 0.00037, 0.03635].reverse(),
    ];

    let re = [
      [0.0071, 0.00726, 0.00773, 0.0163, 0.05464, 0.74926].reverse(),
      [0.00776, 0.01344, 0.0161, 0.02417, 0.04005, 0.14684].reverse(),
      [0.00105, 0.00077, 0.00233, 0.0033, 0.00275, 0.93847].reverse(),
      [0.00036, 0.00062, 0.00063, 0.00062, 0.00072, 0.93236].reverse(),
    ];
