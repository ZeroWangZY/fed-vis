...
class PaperLineChart extends React.Component {
  ...
  getQueryClient = () => {
    let time = [
      ...
      // get ready time
      [2.0314, 2.0415, 2.0445, 2.0673, 2.0621, 2.0942, 2.0662, 2.1009, 2.1031, 2.1338, 2.1967, 2.1967, 2.1884,
        2.315, 2.2815, 2.3045, 2.3659, 2.384, 2.4153, 2.4237, 2.506, 2.5845, 2.5597, 2.6102, 2.6435],

      // exchange rand vector time
      [0.13, 0.164, 0.278, 0.344, 0.432, 0.496, 0.562, 0.677, 0.784, 0.898, 1.061, 1.061, 1.261, 1.525, 1.591,
        1.832, 2.073, 2.1995, 2.507, 2.623, 3.067, 3.246, 3.535, 3.81, 4.237],

      // get data and decryption time
      [0.085, 0.101, 0.131, 0.143, 0.16, 0.184, 0.188, 0.208, 0.225, 0.242, 0.26, 0.26, 0.287, 0.35, 0.334,
        0.347, 0.372, 0.406, 0.415, 0.42, 0.479, 0.48, 0.518, 0.52, 0.527],
    ]
  ...
  getQueryPartition = () => {
    let time = [
      // 随机数向量传输与运算时间
      [7.3458, 3.448, 2.433, 2.1612, 2.1141].reverse(),

      // get ready time
      [2.3158, 2.083, 2.04, 2.0312, 2.0271].reverse(),

      // exchange rand vector time
      [3.451, 0.947, 0.283, 0.089, 0.063].reverse(),

      // get data and decryption time
      [1.579, 0.418, 0.11, 0.041, 0.024].reverse(),
    ]
