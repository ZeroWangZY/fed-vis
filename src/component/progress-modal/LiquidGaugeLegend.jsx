...
class LiquidGaugeLegend extends React.Component {
  ...
  render() {
    ...
    return (<div style={{
      ...
      <canvas style={{ width: 40, height: 40, position: "absolute" }} ref={this.canvas}>当前浏览器不支持canvas 请升级！</canvas>
      <svg style={{ position: "absolute", top: -20 }}>
        <polyline points="20,42 40,20 60,20" fill="none" stroke="rgb(33,33,33)" />
        <text dominantBaseline="text-before-edge" textAnchor="middle" fontSize="14" x="76" y="9">loss</text>
      </svg>
    </div >
    );
  }
